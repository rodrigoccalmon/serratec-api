package org.serratec.backend.exercicio001.controller;
import java.util.ArrayList;
import java.util.List;

import org.serratec.backend.exercicio001.domain.Aluno;
...
public class AlunoController {
	...
	static {
		lista.add(new Aluno(2454L, "Rodrigo", "21 993197403"));
		lista.add(new Aluno(2343L, "Gisele", "21 994517403"));
		lista.add(new Aluno(1409L, "Diego", "21 99999999"));
		lista.add(new Aluno(2456L, "Isabella", "21 123767167321"));
	}
	@GetMapping
